...
ImpressBox is plugin to make easier to configure web development virtual enviroment for Vagrant. It comes with some predefined templates for some popular frameworks and CMS'es (latest versions):
  - [CakePHP](//cakephp.org)
